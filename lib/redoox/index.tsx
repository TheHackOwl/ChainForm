...
export type Thunk<S, A extends Action = any> = (
...
export type DispatchMap<S> = {
  [key: string]: (...args: any[]) => Action | Thunk<S, Action>;
};
...
export function initRedoox<
  R extends AnyReducer,
  S extends React.ReducerState<R>,
>(reducer: R, initialState: S) {
  ...
  function useRedux<StateExtract, ActionMap extends DispatchMap<S>>(
    ...
    const dispatch = React.useContext(DispatchContext) as React.Dispatch<
      React.ReducerAction<R>
    >;
